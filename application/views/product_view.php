	...
	<div class="col-md-12">
		...
		<footer class="page-footer font-small blue">
		  ...
		  <div class="footer-copyright text-center py-3">© 2020:
		    <a href="http://yadunandankushwaha.in"> Yadu Nandan Kushwaha</a>
		  </div>
		  <!-- Copyright -->

		</footer>

		<p style="text-align: center; color: #000;">Made By <a href="https://github.com/yadunandankushwaha/">Yadu Nandan Kushwaha</a></p>
	</div>
